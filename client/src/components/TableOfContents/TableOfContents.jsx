            ...
            <div>
                {this.state.isDesktop &&
                    <div className="font-exo">
                        <div className="margin-auto max-width-17em">
                            <h2>Contents</h2>
                            ...
                            <StickyDiv>
                                    <div className="margin-auto max-width-17em padding-top-1em">
                                        <nav className="bg-255-253-242 border-color border-style-solid border-width-2px display-block font-size-p85em padding-bottom-1em padding-left-1em padding-right-p5em padding-top-1em"  id="table-of-contents">
                                            <div className="padding-bottom-1em">
                                                <a className="padding-bottom-p25em" href="#city-overview">1. City A11Y Overview</a>
                                            ...
                                            <div className="padding-bottom-1em">
                                                <a href="#city-map">2. City A11Y Map</a>
                                            </div>
                                            <div className="padding-bottom-1em">
                                                <a href="#city-attractions">3. City Attractions A11Y</a>
                                                <ul className="padding-left-1p5em padding-top-p25em">
